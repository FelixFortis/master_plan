  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created project" do
        post :create, {:project => valid_attributes}
        expect(response).to redirect_to(user_project_path(@user, @user.projects.last))
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested project" do
        ...
        project.reload
        expect(project.attributes[:title]).to eq(new_attributes["title"])
        expect(project.attributes[:due_date]).to eq(new_attributes["due_date"])
        expect(project.attributes[:description]).to eq(new_attributes["description"])
      end
