...
adam_project_1.milestones.create!(title: "Visit and assess Grenoble", due_date: "2016-09-01", description: "Prices and quality of life assessment in Grenoble") # tag Agathe?
...
adam_project_3.milestones.create!(title: "Average monthly income of £5000", due_date: "2017-01-01", description: "Income from my assets/salary combine to £5000 per month")
...
chloe_project_1.milestones.create!(title: "First steps", due_date: "2016-07-02", description: "Take first unaided steps")